...
### v0.0.39 Changes
- **Bug Fix:** Fixed `isAspectApplying` placeholder in astro.js utilities
  - Replaced placeholder that always returned true with actual angle-based calculation
  - Matches approach used in astrology module's calculateAspect function
...
- **Frontend Spec Compliance:** Fixed responsive grid breakpoints to match spec 02-FRONTEND-UI.md line 102 (4 columns desktop, 2 tablet, 1 mobile)
- **Frontend Spec Compliance:** Fixed geophysical module icon from 🌋 to 🌍 to match spec 02-FRONTEND-UI.md line 62
...
- **Accessibility Enhancements:**
  - Added ARIA live regions for dynamic content updates (predictions panel, error banner)
  - Added prediction change highlighting animation when values update (per spec line 282)
  - Added reduced motion support (@media prefers-reduced-motion)
  - Added aria-hidden to decorative icons
  - Added aria-label attributes to indices for screen readers
